  ...
  return (
    <form className="flex flex-col pt-16 items-center grow space-y-6 text-[14px]">
      ...
      <div className="relative">
        ...
        <input type="text" className="border py-3 px-12 rounded-full w-[400px] md:w-[600px]" placeholder="Enter your search term here..." onChange={(e) => setSearchIntput(e.target.value)} autoFocus/>
