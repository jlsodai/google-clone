...
const SearchBar = ({onChange, value}) => {
  return (
    <div className="relative">
      ...
      <input type="text" className="border py-3 px-12 rounded-full w-[400px] md:w-[600px] hover:shadow focus:outline-none focus:shadow" placeholder="Enter your search term here..." onChange={onChange} value={value} autoFocus/>
